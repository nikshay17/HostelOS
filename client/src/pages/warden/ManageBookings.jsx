                  ...
                  <tr key={b._id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <p className="font-medium text-gray-900 text-sm">{b.student.name}</p>
                          <p className="text-xs text-gray-400">{b.student.studentId}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-3">
                      <p className="font-medium text-gray-900">{b.room.roomNumber}</p>
                      <p className="text-xs text-gray-400 capitalize">{b.room.type} · Floor {b.room.floor}</p>
                    </td>
                    <td className="px-4 py-3 text-gray-500 text-xs">{new Date(b.requestedAt).toLocaleString()}</td>
