              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm font-semibold text-gray-900 capitalize">{f.category}</span>
                  ...
                  <p className="text-xs text-gray-400 mt-1.5">{new Date(f.createdAt).toLocaleDateString()}</p>
                </div>
                <span className="text-2xl font-bold text-gray-200">{f.rating}/5</span>
              </div>
            </Card>
          ))}
        </div>
